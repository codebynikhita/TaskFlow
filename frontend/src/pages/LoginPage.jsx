...
const LoginPage = () => {
  ...
  // Load email from localStorage if "Remember Me" was enabled previously
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setValidationError(err.message || 'Login failed. Please verify credentials.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="glass-panel p-8 rounded-3xl shadow-xl transition-all duration-300 w-full animate-slide-up bg-white/95 dark:bg-slate-900/95">
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
          Access your workspaces and dashboard
        </p>
      </div>
